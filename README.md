...
- This app currently supports only a single session, so multi-session functionality is unavailable. If you encounter any issues, press the 'Reset All' button to start a new story.

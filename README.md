...
![](https://github.com/ikmalsaid/mindful-escapades/blob/main/thumbnail.jpg?raw=true)
...
- This app operates in Single Session Mode, so only one user should be active at a time.
